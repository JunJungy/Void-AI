      ...
      <main className="lg:pl-64 pb-28 pt-4 lg:pt-0">
        ...
        <div className="relative h-[400px] w-full overflow-hidden">
          ...
          <div className="relative z-20 h-full flex flex-col justify-center px-6 md:px-12 max-w-4xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="px-8 py-3 bg-white text-black font-bold rounded-full hover:scale-105 transition-transform flex items-center justify-center gap-2">
        ...
        <div className="px-6 md:px-12 mt-8">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-xl md:text-2xl font-display font-bold">Trending Now</h2>
        ...
        <div className="px-6 md:px-12 mt-16">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-xl md:text-2xl font-display font-bold">Fresh Drops</h2>
            <button className="text-sm text-muted-foreground hover:text-primary transition-colors">View All</button>
          </div>
